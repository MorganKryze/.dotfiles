...
If you have any questions, issues, or feedback regarding these `dotfiles` you're in the right place! Please take a moment to review the guidelines below before proceeding:
...
- **Question or Support Request**: Use this template if you have a general question about the `dotfiles` or need assistance with using it.

## Guidelines for Issue Creation

When creating an issue, please provide as much relevant information as possible, including:

- **`dotfiles` Version**: Specify the version of the `dotfiles` you're using.
